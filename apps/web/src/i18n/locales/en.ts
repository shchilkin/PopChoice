...
export const en = {
  ...
  results: {
    ...
    feedbackHint: 'Your feedback helps PopChoice learn what to improve next.',
    ...
    morePicksTitle: 'Where should we widen the search?',
    morePicksHint: 'Pick a direction and PopChoice will add more options around this mood.',
    morePicksLensPopular: 'More popular',
    morePicksLensCozier: 'Cozier',
    morePicksLensBolder: 'Bolder',
    morePicksLensShorter: 'Shorter',
    morePicksButton: 'Widen: {lens}',
    ...
    morePicksCompleted: 'Added new options below — compare them with the main pick.',
  },
  about: {
