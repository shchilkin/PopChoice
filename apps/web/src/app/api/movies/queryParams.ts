...
export function parseMoviesQueryParams(searchParams: URLSearchParams): MoviesQueryParams {
  return {
...
export function getMoviesQueryValidationError(params: MoviesQueryParams): string | undefined {
