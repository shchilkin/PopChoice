...
export default function ResultsPage() {
  ...
  const ambientColor = useAmbientColor(mainMovie?.posterURL);
  ...
  if (isLoading) {
    return (
      <div className="page-main flex-1 flex items-center justify-center min-h-[60vh]">
  ...
  return (
    <>
      {/* Ambient poster glow — fixed overlay, behind all content */}
      <div
        aria-hidden="true"
        className="fixed inset-0 pointer-events-none"
        style={{
          background: ambientColor
            ? `radial-gradient(ellipse 90% 55% at 50% 0%, rgba(${ambientColor.r},${ambientColor.g},${ambientColor.b},0.18) 0%, transparent 70%)`
            : 'none',
      ...
      />
      <div
        className="page-main px-4 md:px-8 py-8 max-w-3xl mx-auto w-full"
