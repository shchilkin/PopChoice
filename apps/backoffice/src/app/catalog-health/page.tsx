...
export default async function CatalogHealthRoute({ searchParams }: CatalogHealthRouteProps) {
  try {
    ...
    return <BackofficeErrorPage active="health" error={error} retryHref="/catalog-health" />;
  }
}
