      ...
      <section className="relative min-h-[92vh] flex flex-col items-center justify-center px-5 overflow-hidden">
        ...
        <div className="relative z-10 flex flex-col items-center text-center max-w-2xl">
          ...
          <motion.div
            ...
            className="mb-6"
          >
            <PopcornMascot size={130} animated />
          </motion.div>
          ...
          >
            {/* Gradient-text on a non-transformed child so webkit-background-clip
                doesn't break when the motion parent updates its transform */}
            <span
              style={{
      ...
      <section className="relative overflow-hidden py-20 px-5">
        ...
        >
          ...
          <p className="mb-8" style={{ color: 'var(--pc-t2)', lineHeight: 1.7 }}>
            Whether it's a cozy solo night or a rowdy group screening, PopChoice reads the room and
            delivers a pick everyone will love.
          </p>
          <button
            onClick={() => navigate('/quiz')}
