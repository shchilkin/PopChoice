          ...
          <div className="flex flex-col gap-4">
            ...
            >
              <div
                ...
                style={{ background: 'rgba(245,197,24,0.15)', color: 'var(--pc-gold)' }}
              >
                <User size={22} />
              </div>
              <div>
        ...
        >
            ...
            {groupNames.map((name, i) => (
              <div key={i} className="flex items-center gap-3">
                <div
                  ...
                  style={{ background: 'rgba(139,92,246,0.2)', color: '#A78BFA', fontWeight: 700 }}
                >
                  {i + 1}
                </div>
                <input
          ...
          {groupNames.length < 6 && (
            <button
              ...
              style={{ border: '1px dashed var(--pc-bd4)', color: 'var(--pc-t3)' }}
              onMouseEnter={(e) => {
      ...
      <div className="flex-1 flex flex-col items-center justify-center px-5 min-h-[80vh]">
        ...
        >
          ...
          <p className="mb-8" style={{ color: 'var(--pc-t2)' }}>
            Now it's <span style={{ color: 'var(--pc-gold)', fontWeight: 600 }}>{nextName}</span>
    ...
    <div className="flex-1 flex flex-col min-h-[80vh]">
          ...
          >
            ...
            {currentStep === 0 && (
              <div className="flex flex-col gap-6 pt-2">
                ...
                <p style={{ color: 'var(--pc-t3)', fontSize: '0.88rem', marginTop: -8 }}>
                ...
                {/* Quick suggestions */}
                <div>
                  <p style={{ color: 'var(--pc-t4)', fontSize: '0.78rem', marginBottom: 10 }}>
                    POPULAR PICKS
                  </p>
            ...
            {currentStep === 1 && (
              <div className="flex flex-col gap-6 pt-2">
                <div className="flex items-center gap-3">
                  <div
                    className="w-10 h-10 rounded-xl flex items-center justify-center"
                    style={{ background: 'rgba(255,159,28,0.15)', color: 'var(--pc-amber)' }}
                  >
                    <Clock size={20} />
                  </div>
                  <h2
                    ...
                    return (
                      ...
                      >
                        ...
                        <div className="flex-1">
                          ...
                          <div style={{ color: 'var(--pc-t3)', fontSize: '0.82rem' }}>
                            {opt.desc}
                          </div>
                        </div>
                        {selected && (
                    ...
                    return (
                      ...
                      >
                        ...
                        <div>
                          ...
                          <div style={{ color: 'var(--pc-t3)', fontSize: '0.78rem' }}>{t.desc}</div>
                        </div>
                      </button>
                    );
                  })}
      ...
      <div className="px-5 py-6 max-w-xl mx-auto w-full flex gap-3">
        ...
        <button
          ...
          style={{
            background: canProceed() ? 'var(--pc-cta)' : 'var(--pc-bd2)',
            color: canProceed() ? '#09090F' : 'var(--pc-t4)',
            fontWeight: 700,
