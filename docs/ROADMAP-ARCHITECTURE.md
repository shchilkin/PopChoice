...
- Add responsive backoffice repair actions in [#592](https://github.com/shchilkin/PopChoice/issues/592), including pending/success/error states, duplicate-click protection, and live row/card updates after successful queued repair. Decide in that slice whether to keep progressive-enhanced HTML or introduce a client data layer such as TanStack Query.
