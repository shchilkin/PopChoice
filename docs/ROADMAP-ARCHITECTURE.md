...
- [x] Add TMDB review queue pagination in [#591](https://github.com/shchilkin/PopChoice/issues/591) / [#600](https://github.com/shchilkin/PopChoice/issues/600), preserving filters, sort, page, and page size. Remaining #591 work is catalog-health issue row browsing plus duplicate/audit pagination where useful.
