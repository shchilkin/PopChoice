...
- [ ] Add a native backoffice `catalog-maintenance` queue view in [#627](https://github.com/shchilkin/PopChoice/issues/627), keeping Bull Board as the deeper queue console while surfacing operator-friendly counts, job summaries, and links.
