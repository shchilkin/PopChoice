...
- [x] Add safe review actions and audit/history rules in [#551](https://github.com/shchilkin/PopChoice/issues/551) before allowing operators to apply, reject, or defer catalog fixes. The first implemented slice supports audited TMDB candidate apply/reject/defer/reopen actions; broader catalog-health repair actions remain future follow-up work.
- Add audited catalog-health repair actions in [#559](https://github.com/shchilkin/PopChoice/issues/559), preferring queued/idempotent backfill or discovery repairs over broad direct row mutation.
