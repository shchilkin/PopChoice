...
| `OPERATOR_AUTH_RATE_LIMIT_MAX`            | Backoffice                                      | Optional                                                                                                               | `30`                                                                | Maximum unsuccessful backoffice requests per window. Successful requests are skipped.       |
| `OPERATOR_AUTH_RATE_LIMIT_WINDOW_SECONDS` | Backoffice                                      | Optional                                                                                                               | `900`                                                               | Backoffice operator auth rate-limit window in seconds.                                      |
