-- Corrected match_movies function for Supabase
-- Fix: Changed format specifiers from %d, %.1f to %s for PostgreSQL compatibility
...
as $$
  select
    ...
    -- Format content for API consumption (corrected format specifiers)
    format(
