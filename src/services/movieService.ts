...
export default class MovieService {
  ...
  constructor() {
    ...
    this.apiURLBase = 'https://api.themoviedb.org/3';
  }
...
// TODO: Remove after service is fully implemented and integrated to app
const movieService = new MovieService();

// TODO: Remove after service is fully implemented and integrated to app
const result = await movieService.getMovieByTitle('The martian');

// Example usage of getPosterURL
// TODO: Remove after service is fully implemented and integrated to app
if (result) {
  console.log('Poster', movieService.getPosterURL(result.poster_path, 'w500'));
}
